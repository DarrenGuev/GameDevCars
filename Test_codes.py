...
def main():
    ...
    enemyCar19 = pygame.image.load('bato2.png').convert_alpha()
    enemyCar19 = pygame.transform.scale(enemyCar19, (100, 70))
    enemyCar20 = pygame.image.load('enemyCar20.png').convert_alpha()
    enemyCar20 = pygame.transform.scale(enemyCar20, (40, 70))
    enemyCar21 = pygame.image.load('bato1.png').convert_alpha()
    enemyCar21 = pygame.transform.scale(enemyCar21, (100, 100))
